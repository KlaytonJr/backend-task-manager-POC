...
class TaskController extends Controller {
  ...
  private async list(req: Request, res: Response, next: NextFunction): Promise<Response | any> {
    try {
  ...
  private async findById(req: Request, res: Response, next: NextFunction): Promise<Response | any> {
    try {
      const { id } = req.params;
  ...
  private async create(req: Request, res: Response, next: NextFunction): Promise<Response | any> {
    try {
  ...
  private async edit(req: Request, res: Response, next: NextFunction): Promise<Response | any> {
    try {
      const { id } = req.params;
      if (ValidationService.validateId(id, next)) return;
  ...
  private async delete(req: Request, res: Response, next: NextFunction): Promise<Response | any> {
    try {
      const { id } = req.params;
      if (ValidationService.validateId(id, next)) return;
